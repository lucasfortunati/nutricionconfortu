...
export const seedFoodsData: FoodInput[] = [
  // --- Carnes y aves ---
  { name: "Pechuga de pollo, cruda", category: "Carnes y aves", state: "RAW", kcalPer100g: 120, proteinPer100g: 22.5, fatPer100g: 2.6, carbPer100g: 0, householdUnitName: "1 pechuga mediana", householdUnitGrams: 150, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  ...
  { name: "Muslo de pollo con piel, crudo", category: "Carnes y aves", state: "RAW", kcalPer100g: 233, proteinPer100g: 17, fatPer100g: 18, carbPer100g: 0, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  ...
  { name: "Carne vacuna (nalga), cruda", category: "Carnes y aves", state: "RAW", kcalPer100g: 137, proteinPer100g: 21.6, fatPer100g: 5.4, carbPer100g: 0, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  ...
  { name: "Carne picada común, cruda", category: "Carnes y aves", state: "RAW", kcalPer100g: 219, proteinPer100g: 17.2, fatPer100g: 16.2, carbPer100g: 0, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  ...
  { name: "Bife de chorizo, crudo", category: "Carnes y aves", state: "RAW", kcalPer100g: 220, proteinPer100g: 20, fatPer100g: 15, carbPer100g: 0, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  { name: "Bondiola de cerdo, cruda", category: "Carnes y aves", state: "RAW", kcalPer100g: 143, proteinPer100g: 20, fatPer100g: 6.8, carbPer100g: 0, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  ...
  // --- Pescados y mariscos ---
  { name: "Merluza, cruda", category: "Pescados y mariscos", state: "RAW", kcalPer100g: 86, proteinPer100g: 17.7, fatPer100g: 1.3, carbPer100g: 0, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  ...
  { name: "Atún fresco, crudo", category: "Pescados y mariscos", state: "RAW", kcalPer100g: 130, proteinPer100g: 23.3, fatPer100g: 4.1, carbPer100g: 0, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  ...
  { name: "Salmón, crudo", category: "Pescados y mariscos", state: "RAW", kcalPer100g: 208, proteinPer100g: 20, fatPer100g: 13, carbPer100g: 0, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 0.7},
  ...
  { name: "Arroz blanco, crudo", category: "Cereales y derivados", state: "RAW", kcalPer100g: 365, proteinPer100g: 7.1, fatPer100g: 0.7, carbPer100g: 79.3, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 3},
  ...
  { name: "Fideos secos, crudos", category: "Cereales y derivados", state: "RAW", kcalPer100g: 371, proteinPer100g: 13, fatPer100g: 1.5, carbPer100g: 74.7, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 2.5},
  ...
  // --- Verduras ---
  { name: "Papa, cruda", category: "Verduras", state: "RAW", kcalPer100g: 77, proteinPer100g: 2, fatPer100g: 0.1, carbPer100g: 17, householdUnitName: "1 papa mediana", householdUnitGrams: 150, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, cookedYieldFactor: 1},
  ...
  { name: "Zanahoria, cruda", category: "Verduras", state: "RAW", kcalPer100g: 41, proteinPer100g: 0.9, fatPer100g: 0.2, carbPer100g: 9.6, householdUnitName: "1 unidad", householdUnitGrams: 70, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "B"},
  { name: "Tomate, crudo", category: "Verduras", state: "RAW", kcalPer100g: 18, proteinPer100g: 0.9, fatPer100g: 0.2, carbPer100g: 3.9, householdUnitName: "1 unidad mediana", householdUnitGrams: 120, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "A"},
  { name: "Lechuga", category: "Verduras", state: "RAW", kcalPer100g: 15, proteinPer100g: 1.4, fatPer100g: 0.2, carbPer100g: 2.9, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "A"},
  { name: "Cebolla, cruda", category: "Verduras", state: "RAW", kcalPer100g: 40, proteinPer100g: 1.1, fatPer100g: 0.1, carbPer100g: 9.3, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "B"},
  { name: "Zapallo, cocido", category: "Verduras", state: "COOKED", kcalPer100g: 26, proteinPer100g: 1, fatPer100g: 0.1, carbPer100g: 6.5, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "B"},
  { name: "Zapallito, crudo", category: "Verduras", state: "RAW", kcalPer100g: 17, proteinPer100g: 1.2, fatPer100g: 0.3, carbPer100g: 3.1, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "A"},
  { name: "Brócoli, cocido", category: "Verduras", state: "COOKED", kcalPer100g: 35, proteinPer100g: 2.4, fatPer100g: 0.4, carbPer100g: 7.2, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "A"},
  { name: "Espinaca, cruda", category: "Verduras", state: "RAW", kcalPer100g: 23, proteinPer100g: 2.9, fatPer100g: 0.4, carbPer100g: 3.6, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "A"},
  ...
  { name: "Berenjena, cocida", category: "Verduras", state: "COOKED", kcalPer100g: 35, proteinPer100g: 0.8, fatPer100g: 0.2, carbPer100g: 8.6, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "A"},
  { name: "Morrón rojo, crudo", category: "Verduras", state: "RAW", kcalPer100g: 31, proteinPer100g: 1, fatPer100g: 0.3, carbPer100g: 6, source: "SARA2", sourceDetail: SARA2_NOTE , suitableBreakfast: false, suitableMainMeal: true, vegetableGroup: "A"},
